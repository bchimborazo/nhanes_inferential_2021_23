...
| Question 3: How do age and marital status affect systolic blood pressure? | Regression | Age is the stronger predictor of the two variables. |
| Question 4: Does weight predict sedentary behavior? | Regression | Weight IS a statistically significant predictor of sedentary behavior (p < 0.001). As weight increases, sedentary behavior time also increases. |
